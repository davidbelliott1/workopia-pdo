...
<section>
  <div class="container mx-auto p-4 mt-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      <!--Step through each listing-?salary -->
      <?php foreach ($listings as $listing) : ?>
        <div class="rounded-lg shadow-md bg-white">
          <div class="p-4">
            ...
            <a href="/listing?id=<?= $listing->id ?>" class="block w-full text-center 
              px-5 py-2.5 shadow-sm rounded border text-base font-medium text-indigo-700 
